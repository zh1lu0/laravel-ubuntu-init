...
[[ $? -ne 0 ]] && { echo "仅支持 Ubuntu 20.04 系统"; exit 1; }

DISTRO=$(lsb_release -c -s)
[[ ${DISTRO} -ne "focal" ]] && { echo "仅支持 Ubuntu 20.04 系统"; exit 1; }
...
cd $HOME
wget -q https://github.com/zh1lu0/laravel-ubuntu-init/archive/master.tar.gz -O laravel-ubuntu-init.tar.gz
